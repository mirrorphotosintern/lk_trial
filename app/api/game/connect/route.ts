// API route for connecting to the Padhagala Raaja game AI backend
// Handles creation of Daily rooms and authentication tokens for real-time voice interaction
