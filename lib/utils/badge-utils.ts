 ...
 */
export function getBadgeDefinition(badgeId: string, badges: BadgeDefinition[]): BadgeDefinition | undefined {
 ...
 */
export function getLevelRequirement(badge: BadgeDefinition, level: number): string {
  if (!badge.hasLevels) return ""
  
  switch (level) {
    case 1: return badge.levelRequirements.level1
    case 2: return badge.levelRequirements.level2
    case 3: return badge.levelRequirements.level3
    case 4: return badge.levelRequirements.level4
    case 5: return badge.levelRequirements.level5
    default: return ""
  }
}
 ...
 */
export function formatBadgeProgress(badge: BadgeDefinition, currentLevel: number, progress: number): string {
  if (!badge.hasLevels) {
    return "Badge earned!"
  }
