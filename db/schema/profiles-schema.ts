...
export const profilesTable = pgTable("profiles", {
  ...
  lastSignIn: timestamp("last_sign_in", { withTimezone: true }).defaultNow().notNull(), // Last sign-in timestamp
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(), // When profile was created
  updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow().notNull() // When profile was last updated
})
